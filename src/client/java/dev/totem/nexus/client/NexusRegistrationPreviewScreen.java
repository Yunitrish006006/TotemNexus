...
final class NexusRegistrationPreviewScreen extends Screen {
    private static final int WIDTH = 286, HEIGHT = 142;
    private final SpaceUnitRegistrationPreviewPayload payload;
    NexusRegistrationPreviewScreen(SpaceUnitRegistrationPreviewPayload payload) {
        super(Component.translatable("message.deadrecall.space_unit.registration_gui_title")); this.payload = payload;
    }
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor extractor,int mouseX,int mouseY,float partialTick){int x=(width-WIDTH)/2,y=(height-HEIGHT)/2;
        ...
        extractor.text(font,Component.translatable("message.deadrecall.space_unit.registration_gui_hint"),x+12,y+84,0xFF93A4B5); super.extractRenderState(extractor,mouseX,mouseY,partialTick);}
