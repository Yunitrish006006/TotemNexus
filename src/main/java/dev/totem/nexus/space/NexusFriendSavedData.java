...
public class NexusFriendSavedData extends SavedData {
    ...
    private NexusFriendSavedData(int dataVersion, List<Friendship> friendships, List<PendingFriendInvite> pendingInvites) {
