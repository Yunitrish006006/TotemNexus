...
目前候選版本為 **0.2.0**，精確搭配 TotemCore **0.2.0**。
...
DeadRecall 2.4.4 整合 JAR 時不要再安裝獨立 TotemNexus。
...
identifiers。0.2.0 已通過 root authority seed → external migrate → 第二
...
候選版已通過 26/26 required Fabric GameTests、Dedicated Server、legacy
